...
# When using only list we will do the partition on the bases on int values and while using list column we can do the partition on the bases of categorical value
