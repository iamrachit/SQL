...
# Internially its trying to partition the data with respect to the slots defined
...
# Hash Partition work on hashing algo in which number of partition is dividing the number of year (in our case). 
...
# In the key based partition it will use hash algo aka MD5 
# https://stackhowto.com/mysql-md5/#:~:text=%EE%80%80I%20n%20SQL%EE%80%81%20language%2C%20the%20%EE%80%80MD5%EE%80%81%28%29%20function%20encrypts,in%20a%20%EE%80%80SQL%EE%80%81%20query%20as%20follows%3A%20SELECT%20%EE%80%80MD5%EE%80%81%28%27test%27%29%3B
