show databases; 
# this is for showing the databases present in the server 

create database if not exists ineuron_fsda;
# creating the database in the server 

USE ineuron_fsda;
# selecting ineuron_fsda database for using it 

create table if not exists bank_details( # creating table with the name bank_details
age int,
job varchar(30),
marital varchar(30),
education varchar(30),
`default` varchar(30), # using '' for enabling same name 
balance int , 
housing varchar(30),
loan varchar(30) , 
contact varchar(30),
